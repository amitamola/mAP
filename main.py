...
"""
with open(output_files_path + "/output_gt_per_class.txt", 'a') as output_file:
...
"""
with open(output_files_path + "/output_tp_fp.txt", 'a') as output_file:
...
out = pd.DataFrame({"Symbol":class_n, "Number in GT":gt_pc, "Predicted correctly":tp_pc, "False Positive":fp_pc, "Not Detected":not_det})
